...
function DocumentModal(props: any): JSX.Element | null {
    ...
    const [activeTab, setActiveTab] = useState<"submit" | "feedback">("submit");
    ...
    return modalOpen ? (
        <div className="fixed inset-0 z-[1000] font-[Calibri] flex items-center justify-center bg-black/60 px-4">
            <div className="bg-white dark:bg-[#1E1E1E] rounded-2xl shadow-lg w-full max-w-md h-[78vh] flex flex-col relative animate-in fade-in duration-200 text-gray-800 dark:text-gray-100 overflow-hidden">
    ...
    >
        Feedback
                ...
                {/* Scrollable Content */}
                <div className="flex-1 overflow-y-hidden px-6 pt-2 "> {/* smaller padding bottom */}
                    {/* Close */}
                    <button
                        onClick={handleClose}
                    ...
                    {activeTab === "submit" && !isSubmitted && (
                        <>
                            ...
                            {documents.length === 0 && (
                                <div
                                    className="flex items-center justify-between border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-1 px-3 mb-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-[#2E2E2E] transition"
                            ...
                            {approvals.length === 0 && (
                                <div
                                    className="flex items-center justify-between border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-1 px-3 mb-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-[#2E2E2E] transition"
                            ...
                            <textarea
                                ...
                                className="w-full p-3 border border-gray-300 dark:border-gray-600 bg-white rounded-lg text-sm mb-1 dark:bg-[#2E2E2E]"
                    ...
                    {/* Feedback  */}
                    {activeTab === "feedback" && (
                        <FeedbackModal activeTab={activeTab} handleClose={handleClose}/>
                    )}
